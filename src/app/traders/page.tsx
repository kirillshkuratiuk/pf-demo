...
function BlurredSection({ children, label }: { children: React.ReactNode; label?: string }) {
  return (
    <div style={{ position: "relative" }}>
      <div style={{ filter: "blur(3px)", opacity: 0.6, pointerEvents: "none", userSelect: "none" }}>
        {children}
      </div>
      {label && (
        <div style={{
          position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)",
          background: "rgba(255,255,255,0.9)", borderRadius: "8px", padding: "6px 14px",
          fontSize: "13px", color: "#999", fontWeight: 500, whiteSpace: "nowrap",
...
export default function TradersPage() {
  return (
      ...
      <div style={{ flex: "0 0 70%", minWidth: 0, overflow: "hidden" }}>
        <div className="outer_chart" style={{ width: "100%" }}>
          <div className="outer_border">
            ...
            {/* --- Trader Header (keep sharp — provides context) --- */}
            ...
            {/* --- Blurred: PnL Chart + Controls --- */}
            <BlurredSection label="Placeholder">
              <div className="chart_top_div_outer">
                <div className="chart_lower_div">
                  <div className="chart_pnl">
                    <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img style={{ width: "23px" }} src="/pf-assets/trend-up-green.svg" alt="" />
                ...
                <div style={{ width: "100%", height: "280px", background: "var(--white-secondary, #f4f5f6)", borderRadius: "8px" }} />
              </div>
              <div className="chart-controls-wrapper" style={{ marginTop: "16px", display: "flex", gap: "12px", justifyContent: "space-between", alignItems: "center" }}>
                <div style={{ display: "flex", gap: "12px" }}>
                  <button style={{ padding: "4px 8px", borderRadius: "55px", border: "none", backgroundColor: "var(--card-bg)", display: "flex", alignItems: "center", gap: "5px" }}>
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src="/pf-assets/settings_button.svg" alt="" width="22" height="22" />
                    <span style={{ fontSize: "14px" }}>Settings</span>
                  </button>
                </div>
                <div style={{ display: "flex", gap: "12px" }}>
                  <button style={{ padding: "6px 9px", borderRadius: "55px", border: "none", backgroundColor: "var(--card-bg)", display: "flex", alignItems: "center", gap: "6px" }}>
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src="/pf-assets/projection.svg" alt="" width="11" height="11" />
                    <span style={{ fontSize: "14px" }}>Projection</span>
                  </button>
                  <button style={{ padding: "6px 9px", borderRadius: "55px", border: "none", backgroundColor: "var(--card-bg)", display: "flex", alignItems: "center", gap: "6px" }}>
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src="/pf-assets/share.svg" alt="" width="16" height="16" />
    ...
    {/* ===== FULL WIDTH: Our Features (sharp, no blur) ===== */}
